    ...
    return (
      <div>
        ...
        <AudioControlGroup label='Sweep'>
          <Slider label='Tune'
          min={60} max={200} step={1} defaultValue={150} onInput={drumEnv::drumEnv.setStart} />
          <Slider label='Depth -/+'
          ...
          <Slider label='Decay'
            min={0.0001} max={1} step={0.0001} defaultValue={0.0001} onInput={drumEnv::drumEnv.setDecay} />
        </AudioControlGroup>
