    ...
    return (
      <div>
        <AudioControlGroup label='Osc 1'>
          ...
          <Slider label='Frequency' min='50' max='1200' step='20'
            defaultValue='600' onInput={osc1::osc1.setFrequency} />
        </AudioControlGroup>
        ...
        <AudioControlGroup label='Osc 2'>
          ...
          <Slider label='Frequency' min='50' max='1200' step='20'
            defaultValue='950' onInput={osc2::osc2.setFrequency} />
        </AudioControlGroup>
        ...
        <AudioControlGroup label='Osc 3'>
          ...
          <Slider label='Frequency' min='50' max='1200' step='20'
            defaultValue='300' onInput={osc3::osc3.setFrequency} />
        </AudioControlGroup>
      </div>
    )
  }
