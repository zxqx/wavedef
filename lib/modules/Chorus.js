...
export default class Chorus
{
  constructor()
  {
    ...
    let {input, direct, offset1, offset2, mix, output, offset1pan, offset2pan} = this;
  ...
  setWetDryMix(mix)
  {
    ...
    this.mix.setGain(mix);
  }

  setChorusTime(time)
  {
    this.offset1.setDelayTime(offset);
    this.offset2.setDelayTime(offset);
  }
